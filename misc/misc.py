...
df_sampled = df_filtered.groupby('computingsite').apply(lambda x: x.sample(n=min(2000, len(x)), random_state=42)).reset_index(drop=True)
df_sampled.to_csv('/home/sairam/ATLASGRIDV2/ATLAS-GRID-SIMULATION/data/jan_2000_4_sites.csv', index=False)
# for site in sites:
